<div class="page_holder">
    <div class="page_inner">
        <div class="page_head">
            ...
            <div class="dashbord_nav">
                <ul>
                    ...
                    <li class="active" id="tab_closed_contacts"><a href="<?php echo base_url(); ?>ads/closed"><?php echo lang('closed_contacts'); ?></a></li>
        ...
        <div class="wrapper" id="closed_contacts">
            <div class="page_head">
                <h5><?php echo lang('closed_contacts'); ?>, <?php echo lang('all'); ?></h5>
            </div>
                    ...
                    <tbody>
                        ...
                        if (count($arr_trade_status_list) > 0) {
                            ...
                            foreach ($arr_trade_status_list as $arr_trade) {
							  ...
							  if($arr_trade['transaction_status'] != 'pending') {
