        ...
        <div class="page_head">
            ...
            <div class="dashbord_nav">
                <ul>
                    ...
                    <li class="active" id="tab_cancelled_contacts"><a href="<?php echo base_url(); ?>ads/canceled"><?php echo lang('cancelled_contacts'); ?></a></li>
                </ul>
            </div>
        </div>

        <div class="wrapper" id="cancelled_contacts">
            <div class="page_head">
                <h5><?php echo lang('closed_contacts'); ?>, <?php echo lang('cancelled'); ?></h5>
            </div>
                        ...
                        if (count($arr_trade_status_list) > 0) {
                            ...
                            foreach ($arr_trade_status_list as $arr_trade) {
                                ...
                                if (($user_session['user_id'] == $arr_trade['buyer_id']) || ($user_session['user_id'] == $arr_trade['seller_id'])) {
                                    if ($arr_trade['transaction_status'] == 'cancelled') {
...
//            echo count($arr_trade_status_list);
//            print_r($arr_trade_status_list);
            ?>
            <p><?php echo $links; ?></p>
        <?php } ?>
    </div>
