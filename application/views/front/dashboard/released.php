<div class="page_holder">
    <div class="page_inner">
        <div class="page_head">
            ...
            <div class="dashbord_nav">
                <ul>
                    ...
                    <li class="active" id="tab_released_cotacts"><a href="<?php echo base_url(); ?>ads/released"><?php echo lang('released_contacts'); ?></a></li>
        ...
        <div class="wrapper" id="released_contacts">
            <div class="page_head">
                <h5><?php echo lang('closed_contacts'); ?>, <?php echo lang('finished'); ?></h5>
            </div>
                    ...
                    <tbody>
                        ...
                        if (count($arr_trade_status_list) > 0) {
                            ...
                            foreach ($arr_trade_status_list as $arr_trade) {
                                ...
                                /* If user is involved in current trade activity */
                                if (($user_session['user_id'] == $arr_trade['buyer_id']) || ($user_session['user_id'] == $arr_trade['seller_id'])) {
                                    if ($arr_trade['transaction_status'] == 'released') {
                                        ...
                                        <tr style="background-color: <?php echo $bgcolor; ?>">
                                            <td><a href="<?php echo base_url() . 'ads/detailed-info/' . base64_encode($arr_trade['trade_id']) . '/' . base64_encode($arr_trade['transaction_id']); ?>"><?php echo $arr_trade['transaction_id']; ?></td>
                                            <td><?php echo date($global['date_format'], strtotime($arr_trade['created_on'])); ?></td>
                                            <td><?php echo $deal; ?></td>
                                            <td><?php echo $arr_trade['transaction_status']; ?></td>
                                            <td><?php echo $arr_trade['fiat_currency'] . ' ' . $arr_trade['currency_code']; ?></td>
                                            <td><?php echo exp_to_dec(abs($btc_amount)); ?></td>
                                        	<td><?php echo exp_to_dec(abs($fee_amount));?></td>
