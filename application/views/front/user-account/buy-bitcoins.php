    ...
    function changeLocation() {
        ...
        google.maps.event.addListener(searchBox, 'places_changed', function() {
            ...
            $(function() {
                ...
                /*jQuery.post("<?php echo base_url(); ?>country",{change_lattitude:location.latitude,change_longitude:location.longitude},function(){
                                        location.reload();
                        });*/
        ...
        <div class="bitcoin_form">
            <form class="chng_loctn" name="frm_change_location" id="frm_change_location" action="<?php echo base_url(); ?>country" method="post">
                <fieldset>
                    ...
                    <input type="hidden" name="page" id="page" value="buy-bitcoins" />
                    <div id="maps"></div>
                </fieldset>
            </form>
        </div>
                        ...
                        if (($i % 2) == 0) {
                            ...
                            echo 'greay_row';
                                    ...
                                    ?>">
                                        ...
                                        <td class="button_buy"><a class="actbuy" href="<?php echo base_url(); ?>buy-sell-bitcoin/<?php echo $arrInfo_buy_o[$i]['trade_id']; ?>"><span>&nbsp;</span><?php echo lang('buy'); ?></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        if (($i % 2) == 0) {
                            ...
                            echo 'greay_row';
                                    ...
                                    ?>">
                                        ...
                                        <td class="button_buy"><a class="actbuy" href="<?php echo base_url(); ?>buy-sell-bitcoin/<?php echo $arrInfo_buy_c[$i]['trade_id'] ?>"><span>&nbsp;</span><?php echo lang('buy'); ?></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
