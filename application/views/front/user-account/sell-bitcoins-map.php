                    ...
                    <div class="current_bitcoin">
                        ...
                        if (($i % 2) == 0) {
                            ...
                            echo 'greay_row';
                                    ...
                                    ?>">
                                <div id="marker_<?php echo $arrInfo_sell_c[$i]['trade_id']; ?>" style="display:none;text-align:left;">
                                    <?php echo $arrInfo_sell_c[$i]['user_name']; ?><br />
                                    <?php echo number_format($arrInfo_sell_c[$i]['distance'], 2, '.', ''); ?>km<br />
                                    <?php echo $arrInfo_sell_c[$i]['location']; ?><br />
                                    <?php echo $arrInfo_sell_c[$i]['local_currency_rate'] . '-' . $arrInfo_sell_c[$i]['local_currency_code'] ?>
                                </div>
                                ...
                                <td class="button_buy"><a class="actbuy" href="<?php echo base_url(); ?>buy-sell-bitcoin/<?php echo $arrInfo_sell_c[$i]['trade_id'] ?>"><span>&nbsp;</span>Sell</a></td>
                                </tr>
                            <?php } ?>
