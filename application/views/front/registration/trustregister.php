                    ...
                    <div class="banner_form">
                        ...
                        <div class="banner_form_data">
                            <div class="formdata">
                                ...
                                <form id="frm_user_registration" name="frm_user_registration" method="post" action="<?php echo base_url(); ?>trusted/register/<?php echo base64_encode($arr_user_data['user_id']) ?>">                            	
                                    <fieldset>
