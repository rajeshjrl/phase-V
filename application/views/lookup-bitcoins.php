    ...
    <div class="page_inner">
            ...
            <?php if (count($arrInfo_buy_o) > 0) { ?>
                <div class="bitcoins">
                    <div class="bitcoins_head">
                        <h1><?php echo lang('results_for_buy_bitcoins_online'); ?> in <?php echo $arr_geo_data['country_name']; ?></h1>
                    </div>
                        ...
                        if (($i % 2) == 0) {
                            ...
                            echo 'greay_row';
                                    ...
                                    ?>">
                                        ...
                                        <td class="button_buy"><a class="actbuy" href="<?php echo base_url(); ?>buy-sell-bitcoin/<?php echo $arrInfo_buy_o[$i]['trade_id']; ?>">Buy</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
        ...
        <?php if (isset($arrInfo_sell_o)) { ?>
            <?php if (count($arrInfo_sell_o) > 0) { ?>
                <div class="bitcoins">
                    <div class="bitcoins_head">
                        <h1><?php echo lang('results_for_sell_bitcoins_online'); ?> in <?php echo $arr_geo_data['country_name']; ?></h1>
                    </div>
                    <div class="current_bitcoin">
                        <table class="clickable">
                            <tbody>
                        ...
                        if (($i % 2) == 0) {
                            ...
                            echo 'greay_row';
                                    ...
                                    ?>">
                                        ...
                                        <td class="button_buy"><a class="actbuy" href="<?php echo base_url(); ?>buy-sell-bitcoin/<?php echo $arrInfo_sell_o[$i]['trade_id'] ?>">Sell</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
