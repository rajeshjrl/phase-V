        ...
        <div id="content" class="span10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li> <a href="javascript:void(0);">Add Payment Method</a> </li>
                </ul>
            </div>
            <div class="row-fluid sortable"> 
                ...
                <div class="box span12">
                    <div class="box-header well">
                        <h2><i class=""></i>Add Payment Method</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form name="frm_add_payment_method" id="frm_add_payment_method" action="<?php echo base_url(); ?>backend/payment-method/add" method="post" >
                            <div class="control-group">
                                <label class="control-label" for="subject">Method Name <sup style="color: red;">*</sup></label>
                                <div class="controls">
                                    <input type="text" required dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="method_name" value="" id="method_name" size="1000"/>
                                </div>
                            </div>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
									<textarea type="text" required dir="ltr" style="margin-left:200px; margin-top:-28px;width:400px;height:75px;" class="FETextInput" name="method_description" value="" id="method_description"></textarea>                                  
                                </div>
                            </div>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" required dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="method_url" value="" id="method_url" size="1000"/>
                                </div>
                            </div>
							
							<div class="control-group">
                            	<label class="control-label" for="parent_id">Risk Level<sup style="color: red;">*</sup></label>
								<div class="controls">
