        ...
        <div id="content" class="span10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li> <a href="javascript:void(0);">Add Currency</a> </li>
                </ul>
            </div>
            <div class="row-fluid sortable"> 
                ...
                <div class="box span12">
                    <div class="box-header well">
                        <h2><i class=""></i>Add Currency</h2>
                        <div class="box-icon">
                            <a title="Add Currency" class="btn btn-plus btn-round" href="<?php echo base_url(); ?>backend/currency/list"><i class="icon-arrow-left"></i></a>
                        </div>
                    ...
                    <div class="box-content">
                        <form name="frm_currency" id="frm_currency" action="<?php echo base_url(); ?>backend/currency/add-currency" method="post" >
                            <div class="control-group">
                                <label class="control-label" for="subject">Currency Name <sup style="color: red;">*</sup></label>
                                <div class="controls">
                                    <input type="text" dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="currency_name" id="currency_name" size="1000"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="content">Currency code </label>
                                <div class="controls">
                                    <input type="text" dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="currency_code" id="currency_code" size="1000"   />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="content">Currency Exchange code </label>
                                <div class="controls">
                                    <input type="text" dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="currency_exchange_code"  id="currency_exchange_code" size="1000"   />
                                </div>
                            </div>
                            <div class="control-group">                                
...
<style> .error{ color: #BD4247;margin-left: 202px;width: 400px;}</style>