                    ...
                    <div class="box-content">
                        <form name="frm_currency" id="frm_currency" action="<?php echo base_url(); ?>backend/forum-category-edit/<?php echo(isset($arr_froum_categories_info['category_id'])) ? $arr_froum_categories_info['category_id'] : ''; ?>" method="post" >
                            ...
                            <div class="control-group">                                
                                ...
                                <div class="controls">
                                    ...
                                    <option value="0" >Select Parent Category</option> 
                                     <?php foreach($arr_froum_categories_list as $arr_categories){ 
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                   <input type="text" dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="page_url" value="<?php echo $arr_froum_categories_info['page_url']; ?>" id="page_url" />
                                     <input type="hidden" dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="page_url_old" value="<?php echo $arr_froum_categories_info['page_url']; ?>" id="page_url_old" />
                                </div>
                            </div>
