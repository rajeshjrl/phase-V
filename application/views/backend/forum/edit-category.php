        ...
        <div id="content" class="span10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li> <a href="javascript:void(0);">Edit Forum Category</a> </li>
                </ul>
            </div>
            <div class="row-fluid sortable"> 
                ...
                <div class="box span12">
                    <div class="box-header well">
                        <h2><i class=""></i>Update Forum Category</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form name="frm_currency" id="frm_currency" action="<?php echo base_url(); ?>backend/forum-category-edit/<?php echo(isset($arr_froum_categories_info['category_id'])) ? $arr_froum_categories_info['category_id'] : ''; ?>" method="post" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="category_name" value="<?php echo $arr_froum_categories_info['category_name']; ?>" id="category_name" size="1000"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="page_title" value="<?php echo $arr_froum_categories_info['page_title']; ?>" id="page_title" size="1000"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea  dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="page_keywords"  id="page_keywords" size="1000" ><?php echo $arr_froum_categories_info['page_keywords']; ?> </textarea>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea  dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="page_description"  id="page_description" size="1000" ><?php echo $arr_froum_categories_info['page_description']; ?></textarea> 
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" readonly dir="ltr" style="margin-left:200px; margin-top:-28px" class="FETextInput" name="page_url" value="<?php echo $arr_froum_categories_info['page_url']; ?>" id="page_url" />
                                    <input type="hidden" dir="ltr"   name="page_url_old" value="<?php echo $arr_froum_categories_info['page_url']; ?>" id="page_url_old" />
                                    <input type="hidden" dir="ltr"   name="category_id"  id="category_id" value="<?php echo $arr_froum_categories_info['category_id']; ?>" id="category_id" />
