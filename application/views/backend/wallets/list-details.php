            ...
            <div class="row-fluid sortable">  
                ...
                <div class="box span12">
                    <div class="box-header well">
                        <h2><i class=""></i>Wallets Management</h2>
                        <div class="box-icon">
                            <a title="back to wallets" class="btn btn-plus btn-round" href="<?php echo base_url(); ?>backend/wallet-list"><i class="icon-arrow-left"></i></a>
                        </div>
                    </div>
                    <br >
                    <form name="frm_users" id="frm_users" action="<?php echo base_url(); ?>backend/user/list" method="post">
                        ...
                        <div class="box-content">
                            <table  class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <th width="20%" class="workcap">Wallet address</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="worktd"  align="left"><a href="https://blockchain.info/address/<?php echo stripslashes($user_wallet['wallet_address']); ?>?filter=0" target="_blank"><?php echo stripslashes($user_wallet['wallet_address']); ?></a></td>
